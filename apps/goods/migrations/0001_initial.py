    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_old_price', models.FloatField(default=0, verbose_name='本店原先价格')),
                ...
                ('goods_red_label', models.TextField(max_length=15, verbose_name='商品标签')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='goods/images/', verbose_name='封面图')),
                ('goods_cut_off_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='商品销售截止时间')),
